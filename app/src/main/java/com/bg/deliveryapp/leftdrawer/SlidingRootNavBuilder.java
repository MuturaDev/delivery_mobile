package com.bg.deliveryapp.leftdrawer;
...
import com.bg.deliveryapp.leftdrawer.transform.CompositeTransformation;
import com.bg.deliveryapp.leftdrawer.transform.ElevationTransformation;
import com.bg.deliveryapp.leftdrawer.transform.RootTransformation;
import com.bg.deliveryapp.leftdrawer.transform.ScaleTransformation;
import com.bg.deliveryapp.leftdrawer.transform.YTranslationTransformation;
import com.bg.deliveryapp.leftdrawer.util.ActionBarToggleAdapter;
import com.bg.deliveryapp.leftdrawer.util.DrawerListenerAdapter;
import com.bg.deliveryapp.leftdrawer.util.HiddenMenuClickConsumer;
...
public class SlidingRootNavBuilder {
    ...
    private static final float DEFAULT_END_SCALE = 0.75f;
    ...
    protected void initToolbarMenuVisibilityToggle(final SlidingRootNavLayout sideNav, View drawer) {
        if (toolbar != null) {
            final ActionBarToggleAdapter dlAdapter = new ActionBarToggleAdapter(activity);
           ...
           final ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(activity, dlAdapter, toolbar,
            ...
            toggle.setToolbarNavigationClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                  //  Toast.makeText(activity, "Clicked", Toast.LENGTH_SHORT).show();
                    ...
                    if (dlAdapter.isDrawerVisible(GravityCompat.START)) {
                        dlAdapter.closeDrawer(GravityCompat.START);

                    } else {
                        dlAdapter.openDrawer(GravityCompat.START);
            ...
            toggle.syncState();
            DrawerListenerAdapter listenerAdapter = new DrawerListenerAdapter(toggle, drawer,activity,toggle);
